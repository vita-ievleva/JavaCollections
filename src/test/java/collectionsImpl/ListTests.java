...
public abstract class ListTests {
    ...
    private CustomList<String> list = getList();
    ...
    public void testRemove1() throws Exception {
        ...
        Stream.of("1", "2", "3", "4", "5").forEach(item -> Assert.assertEquals(true, list.remove(item)));
    ...
    public void testGet() throws Exception {
        list.add(0, "FirstElement");
        Assert.assertEquals(list.get(0), "FirstElement");
    }
